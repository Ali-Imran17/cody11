    ...
    <div className="relative min-h-screen transition-colors text-white font-sans selection:bg-orange-500/30 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="relative min-h-screen flex flex-col items-center pt-8 sm:pt-8 md:pt-10 px-4 overflow-hidden">
          ...
          {/* Navbar */}
          <nav className="z-50 relative md:mx-auto ml-auto w-fit bg-neutral-900 backdrop-blur-2xl border border-white/30 px-4 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-full mb-8 sm:mb-12 md:mb-16 shadow-[inset_0_2px_10px_rgba(255,255,255,0.2)]">
            ...
            <div className="flex justify-between items-center">
              ...
              {/* Mobile Hamburger */}
              <label htmlFor="menu-toggle" className="md:block lg:hidden ml-auto text-white text-2xl cursor-pointer">
                ☰
              </label>
            </div>
            {/* Mobile Dropdown */}
            <div className="absolute right-0 top-14 sm:top-16 w-52 bg-neutral-900 border border-white/20 rounded-2xl p-6 flex-col gap-4 text-white hidden peer-checked:flex lg:hidden">
              <Link href='/' className='hover:text-[#ff8d28]'>Home</Link>
              <Link href='/aboutus' className='hover:text-[#ff8d28]'>About</Link>
              <Link href='/codycommerce' className='hover:text-[#ff8d28]'>Cody's Commerce</Link>
              <Link href='/pricing' className='hover:text-[#ff8d28]'>Pricing</Link>
            ...
            {[
              ...
              <React.Fragment key={idx}>
                <div className="flex flex-col items-center">
                  <div className="cursor-pointer transition-transform duration-300 hover:border-orange-500 hover:shadow-amber-600 hover:scale-105 active:scale-95 p-4 sm:p-5 md:p-6 h-24 w-24 sm:h-28 sm:w-28 md:h-44 md:w-40 lg:h-52 lg:w-44 shadow-[inset_0_4px_15px_rgba(255,255,255,0.2)] bg-[#1c130d]/90 backdrop-blur-md border border-gray-400/70 rounded-2xl flex items-center justify-center">
                    <Image src={item.img} alt={`icon-${idx}`} width={120} height={120} className="object-contain w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-28 lg:h-28" />
                  </div>
                ...
                {idx < 2 && (
                  <>
                    <span className="hidden md:flex text-white text-3xl sm:text-4xl lg:text-5xl items-center justify-center">⟶</span>
                    <span className="flex md:hidden text-white text-2xl sm:text-3xl items-center justify-center rotate-90">→</span>
                  </>
                )}
              </React.Fragment>
            ))}
        ...
        {/* Partners Section */}
          ...
          <div className="relative shadow-[inset_0_2px_13px_rgba(255,255,255,0.2)] bg-[#161616] w-full max-w-5xl h-48 sm:h-56 md:h-64 lg:h-90 rounded-[60px] sm:rounded-[80px] md:rounded-[100px] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] flex items-center justify-center">
            ...
            <div className="absolute -bottom-8 sm:-bottom-10 left-1/2 -translate-x-1/2 shadow-[inset_0_4px_15px_rgba(255,255,255,0.2)] bg-[#341513] backdrop-blur-md border border-[#ffe100]/30 px-4 sm:px-5 md:px-6 py-2 rounded-[30px] sm:rounded-[40px] flex items-center gap-2 sm:gap-3 md:gap-4">
              ...
              <div className="flex flex-col text-[10px] sm:text-xs md:text-sm">
                <div className="flex text-yellow-500 ml-4  text-[8px] sm:text-[10px] md:text-xs">★ ★ ★ ★ ★</div>
                <div className="text-white/80 text-[6px]  sm:text-[8px] md:text-[10px] font-medium whitespace-nowrap">100+ 5 Star Reviews</div>
              </div>
            </div>
        ...
        <section className="py-16 sm:py-20 md:py-24 lg:py-32 px-4 relative">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 sm:mb-16 md:mb-20">
              <h2 className="text-xs text-nowrap sm:text-xl md:text-2xl lg:text-3xl font-bold text-white mb-3 sm:mb-4 ">
                Scale Your Brand with a Partner Who Invests in You<br/>
                Your dedicated team for eCommerce acceleration
              </h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 max-w-6xl mx-auto px-4 md:px-8">
              {[
                ...
                { id: '02', title: 'CAPITAL', icon: '/earning.png', desc: 'We act as a strategic investor, fueling your operations through substantial wholesale purchase orders and funded advertising initiatives. Leveraging our extensive vendor network and history of $500K+ in revenue generation.' },   
                ...
                <div key={service.id} className="relative group">
                  <div className="bg-[#121212] backdrop-blur-md border border-gray-400 rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-7 lg:p-8 shadow-[inset_0_4px_15px_rgba(255,255,255,0.2)] transition-all duration-300 hover:shadow-[0_0_40px_rgba(255,170,0,0.35)] hover:border-orange-500/60 hover:scale-[1.02] active:scale-95 cursor-pointer">
                    <div className="absolute -top-3 -left-3 sm:-top-4 sm:-left-4 md:-top-5 md:-left-5 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center text-xs sm:text-sm md:text-lg font-medium text-white rounded-full border border-gray-400/70 bg-[#121212] -rotate-14 shadow-[inset_0_4px_15px_rgba(255,255,255,0.2)]">
                      {service.id}
                    </div>
                    <div className="flex justify-center mb-3 sm:mb-4 md:mb-6">
                      <img src={service.icon} alt={service.title} className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 object-contain" />
                    </div>
                    <h3 className="text-white text-base sm:text-lg md:text-xl lg:text-2xl text-center tracking-widest uppercase mb-2 sm:mb-3 md:mb-4">
                      {service.title}
                    </h3>
                    <p className="text-white text-xs sm:text-sm md:text-base text-center leading-relaxed mt-2 md:mt-3">
                      {service.desc}
                    </p>
                  </div>
                </div>
                ...
                {icons.map((icon, index) => (
                  <div key={icon.name} className="flex items-center flex-1 min-w-0">
                    <div className="flex flex-col items-center relative">
                      ...
                      >
                        <img src={icon.img} alt={icon.name} className="w-5 sm:w-6 md:w-8 lg:w-10 object-contain" />
                      </div>
